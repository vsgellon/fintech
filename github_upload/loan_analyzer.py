...
print("The total value of all of the loans is $", sum(loan_costs))

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
avg = sum(loan_costs) / len(loan_costs)
print("The average value of all of the loans is $", avg)
...
print("This is the future value: $", future_value, "and this is the remaining months:", remaining_months)
